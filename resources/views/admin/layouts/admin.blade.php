...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sidebar-inner {
            width: var(--sidebar-width);   /* fixed – prevents text wrapping */
        ...
        .sidebar.collapsed .nav-link .link-text { opacity: 0; }
        ...
        .sidebar .btn-logout:hover { background: rgba(220,53,69,0.1); }
        .sidebar .btn-logout i { font-size: 1.1rem; flex-shrink: 0; }
        .sidebar .btn-logout .link-text {
            opacity: 1;
            transition: opacity var(--sidebar-transition);
        }
        .sidebar.collapsed .btn-logout .link-text { opacity: 0; }
        ...
        #sidebarToggle i { font-size: 1.15rem; }

        .header-title { font-weight: 600; font-size: 1.05rem; flex: 1; }
        .header-user { color: #666; font-size: 0.9rem; white-space: nowrap; }
        ...
        @media (max-width: 767.98px) {
            ...
            .sidebar.collapsed {
                width: var(--sidebar-width);   /* keep full width on mobile */
