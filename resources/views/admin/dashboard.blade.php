    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm" style="border-radius: 16px;">
                <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold">Register Students</h5>
                    <a href="{{ route('admin.students.index') }}"
                        class="btn btn-sm btn-light border fw-bold text-primary">View All</a>
                </div>
                            ...
                            <tbody>
                                @foreach ($recentStudents as $student)
                                    <tr>
                                        ...
                                        <td><span
                                                class="text-muted small">{{ $student->studentProfile->district->bn_name ?? '-' }}</span>
                                        </td>
                                        <td><span
                                                class="badge bg-light text-dark border fw-normal">{{ $student->training->course->name ?? '-' }}</span>
                                        </td>
                                        <td>
                                            @if ($student->training)
                                                <span
                                                    class="badge bg-success-subtle text-success px-3">{{ ucfirst($student->training->status) }}</span>
                                            @else
        ...
        <div class="col-lg-4">
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <a href="{{ route('admin.courses.create') }}" class="quick-action-card">
                                <div class="quick-action-icon bg-primary-subtle text-primary"><i class="bi bi-plus-lg"></i>
                                </div>
                        ...
                        <div class="col-6">
                            <a href="{{ route('admin.centers.create') }}" class="quick-action-card">
                                <div class="quick-action-icon bg-warning-subtle text-warning"><i class="bi bi-geo-alt"></i>
                                </div>
                        ...
                        <div class="col-6">
                            <a href="{{ route('admin.success-stories.create') }}" class="quick-action-card">
                                <div class="quick-action-icon bg-success-subtle text-success"><i class="bi bi-quote"></i>
                                </div>
            ...
            <div class="card border-0 shadow-sm mt-4 bg-primary text-white overflow-hidden position-relative"
                style="border-radius: 16px; background: linear-gradient(135deg, #17264f 0%, #1a6b3c 100%) !important;">
                ...
                <i class="bi bi-shield-check position-absolute bottom-0 end-0 m-n4 opacity-10"
